...
import 'package:tfg_v2/di/dependency_injection.dart' as _i31;
...
import 'package:tfg_v2/domain/repository/social/category_repository.dart'
    as _i18;
import 'package:tfg_v2/domain/repository/social/plan_repository.dart' as _i25;
import 'package:tfg_v2/domain/repository/social/user_repository.dart' as _i16;
import 'package:tfg_v2/domain/use_cases/auth/login.dart' as _i22;
import 'package:tfg_v2/domain/use_cases/auth/logout.dart' as _i24;
import 'package:tfg_v2/domain/use_cases/social/follow_user.dart' as _i19;
...
import 'package:tfg_v2/ui/viewmodel/login/login_viewmodel.dart' as _i23;
...
import 'package:tfg_v2/ui/viewmodel/plans/plans_viewmodel.dart' as _i29;
import 'package:tfg_v2/ui/viewmodel/profile/profile_viewmodel.dart' as _i30;
import 'package:tfg_v2/ui/viewmodel/search/search_viewmodel.dart' as _i13;
import 'package:tfg_v2/ui/viewmodel/splash/splash_viewmodel.dart' as _i26;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i19.FollowUserUseCase>(
        () => _i19.FollowUserUseCase(gh<_i16.UserRepository>()));
    gh.factory<_i20.GetUpdatedLoggedUserUseCase>(
        () => _i20.GetUpdatedLoggedUserUseCase(gh<_i16.UserRepository>()));
    ...
    gh.factory<_i23.LoginViewModel>(
        () => _i23.LoginViewModel(gh<_i22.LoginUseCase>()));
    gh.factory<_i24.LogoutUseCase>(() => _i24.LogoutUseCase(
          gh<_i17.AuthRepository>(),
          gh<_i16.UserRepository>(),
        ));
    gh.factory<_i25.PlanRepository>(
        () => _i25.PlanRepositoryImpl(gh<_i11.RemoteDatasource>()));
    gh.factory<_i26.SplashViewModel>(
        () => _i26.SplashViewModel(gh<_i20.GetUpdatedLoggedUserUseCase>()));
    gh.factory<_i27.UserJoinQuitPlanUseCase>(() => _i27.UserJoinQuitPlanUseCase(
          gh<_i25.PlanRepository>(),
          gh<_i16.UserRepository>(),
        ));
    gh.factory<_i28.CreatePlanViewModel>(() => _i28.CreatePlanViewModel(
          gh<_i18.CategoryRepository>(),
          gh<_i25.PlanRepository>(),
          gh<_i16.UserRepository>(),
        ));
    gh.factory<_i29.PlansViewModel>(() => _i29.PlansViewModel(
          gh<_i25.PlanRepository>(),
          gh<_i27.UserJoinQuitPlanUseCase>(),
          gh<_i16.UserRepository>(),
        ));
    gh.factoryParam<_i30.ProfileViewModel, String, bool>((
      userRef,
      isUserRefId,
    ) =>
        _i30.ProfileViewModel(
          userRef: userRef,
          isUserRefId: isUserRefId,
          joinQuitPlanUseCase: gh<_i27.UserJoinQuitPlanUseCase>(),
...
class _$DiModule extends _i31.DiModule {}
